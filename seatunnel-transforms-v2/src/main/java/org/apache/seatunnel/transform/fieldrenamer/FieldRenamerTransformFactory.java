...
public class FieldRenamerTransformFactory implements TableTransformFactory {
    @Override
    public String factoryIdentifier() {
        return FieldRenamerTransform.PLUGIN_NAME;
    }
    ...
    public TableTransform createTransform(TableTransformFactoryContext context) {
        return () ->
                new FieldRenamerTransform(
                        context.getCatalogTables(), FieldRenamerConfig.of(context.getOptions()));
    }
}
