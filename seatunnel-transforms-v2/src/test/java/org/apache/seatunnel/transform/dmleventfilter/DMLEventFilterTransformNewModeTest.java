...
public class DMLEventFilterTransformNewModeTest {
    ...
    void testAppendMode() {
        ...
        SeaTunnelRow read = rowOf(RowKind.READ, 4, "d");
        SeaTunnelRow out4 = t.map(read);
        Assertions.assertEquals(RowKind.READ, out4.getRowKind());
        Assertions.assertEquals(
                DMLEventFilterTransformConfig.READ_MARKER_VALUE.defaultValue(), out4.getField(3));
    }
