                    ...
                    tablePath -> {
                        countPerTable.put(
                                ...
                                metricsContext.counter(
                                        sinkWriteCount + "#" + getFullName(tablePath)));
                        QPSPerTable.put(
                                getFullName(tablePath),
                                metricsContext.meter(sinkWriteQps + "#" + getFullName(tablePath)));
                        bytesPerTable.put(
                                getFullName(tablePath),
                                metricsContext.counter(
                                        sinkWriteBytes + "#" + getFullName(tablePath)));
                        bytesPerSecondsPerTable.put(
                                getFullName(tablePath),
                                metricsContext.meter(
                                        sinkWriteBytesPerSeconds + "#" + getFullName(tablePath)));
                    });
        }
    }
