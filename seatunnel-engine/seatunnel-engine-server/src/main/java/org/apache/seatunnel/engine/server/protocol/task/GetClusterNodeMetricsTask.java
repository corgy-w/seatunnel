...
public class GetClusterNodeMetricsTask extends AbstractSeaTunnelMessageTask<Void, String> {
    protected GetClusterNodeMetricsTask(
        ...
        super(
                ...
                connection,
                m -> null,
                SeaTunnelGetClusterNodeMetricsCodec::encodeResponse);
    }
