 ...
 * and regenerate it.
 */
@Generated("manual-st-3373")
public final class SeaTunnelGetClusterNodeMetricsCodec {
    // hex: 0xDE1300
    public static final int REQUEST_MESSAGE_TYPE = 14553856;
    // hex: 0xDE1301
    public static final int RESPONSE_MESSAGE_TYPE = 14553857;
    ...
    private SeaTunnelGetClusterNodeMetricsCodec() {}

    public static ClientMessage encodeRequest() {
        ClientMessage clientMessage = ClientMessage.createForEncode();
        clientMessage.setRetryable(true);
        clientMessage.setOperationName("SeaTunnel.GetClusterNodeMetrics");
