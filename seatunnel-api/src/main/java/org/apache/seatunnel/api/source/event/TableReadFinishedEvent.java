...
@Setter
@ToString
public class TableReadFinishedEvent implements Event {
    private String databaseName;
    private String schemaName;
    private String tableName;
    private long createdTime;
    private String jobId;
    private EventType eventType = EventType.TABLE_READ_FINISHED;

    public TableReadFinishedEvent(TablePath tablePath) {
        if (tablePath != null) {
