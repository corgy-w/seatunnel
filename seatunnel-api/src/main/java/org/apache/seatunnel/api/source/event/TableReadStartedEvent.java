...
@Setter
@ToString
public class TableReadStartedEvent implements Event {
    private String databaseName;
    private String schemaName;
    private String tableName;
    private long createdTime;
    private String jobId;
    private EventType eventType = EventType.TABLE_READ_STARTED;

    public TableReadStartedEvent(TablePath tablePath) {
