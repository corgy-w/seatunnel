...
public class DebeziumRowConverter implements Serializable {
    ...
    public final Map<String, DateTimeFormatter> fieldFormatterMap = new HashMap<>();
        ...
        switch (sqlType) {
            ...
            case TIME:
                ...
                if (timeFormatter == null) {
                    timeFormatter = DateUtils.matchDateTimeFormatter(timeStr);
            ...
            case TIMESTAMP:
                ...
                if (timestampFormatter == null) {
                    timestampFormatter = DateUtils.matchDateTimeFormatter(timestampStr);
