...
public class DamengPartition implements Partition {
    private static final String SERVER_PARTITION_KEY = "server";

    private final String serverName;

    public DamengPartition(String serverName) {
    ...
    static class Provider implements Partition.Provider<DamengPartition> {
        ...
        public Set<DamengPartition> getPartitions() {
            return Collections.singleton(new DamengPartition(connectorConfig.getLogicalName()));
        }
    }
}
