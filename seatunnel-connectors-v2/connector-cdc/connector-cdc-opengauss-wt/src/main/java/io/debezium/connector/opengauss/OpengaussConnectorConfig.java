...
public class OpengaussConnectorConfig extends RelationalDatabaseConnectorConfig {
    ...
    public static final Field LOGICAL_DECODING_MESSAGE_PREFIX_EXCLUDE_LIST =
            Field.create("message.prefix.exclude.list")
                    ...
                    .withValidation(
                            Field::isListOfRegex,
                            OpengaussConnectorConfig::validateLogicalDecodingMessageExcludeList)
                    .withDescription(
    ...
    public OpengaussConnectorConfig(Configuration config) {
        ...
        this.truncateHandlingMode =
                TruncateHandlingMode.parse(
                        config.getString(OpengaussConnectorConfig.TRUNCATE_HANDLING_MODE));
        ...
        String hstoreHandlingModeStr =
                config.getString(OpengaussConnectorConfig.HSTORE_HANDLING_MODE);
        ...
        this.intervalHandlingMode =
                IntervalHandlingMode.parse(
                        config.getString(OpengaussConnectorConfig.INTERVAL_HANDLING_MODE));
    ...
    protected Duration statusUpdateInterval() {
        return Duration.ofMillis(
                getConfig().getLong(OpengaussConnectorConfig.STATUS_UPDATE_INTERVAL_MS));
    }
    ...
    protected SourceInfoStructMaker<? extends AbstractSourceInfo> getSourceInfoStructMaker(
        ...
        switch (version) {
            case V1:
                return new LegacyV1OpengaussSourceInfoStructMaker(
