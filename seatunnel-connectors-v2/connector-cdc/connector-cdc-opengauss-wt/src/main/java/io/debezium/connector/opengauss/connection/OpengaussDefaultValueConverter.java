...
import io.debezium.connector.opengauss.utils.DefaultValueConverter;
...
public class OpengaussDefaultValueConverter implements DefaultValueConverter {
    ...
    public OpengaussDefaultValueConverter(
            OpengaussValueConverter valueConverters, TimestampUtils timestampUtils) {
