...
public class OpengaussConnector extends RelationalBaseSourceConnector {
    ...
    protected void validateConnection(Map<String, ConfigValue> configValues, Configuration config) {
        ...
        final ConfigValue slotNameValue =
                configValues.get(OpengaussConnectorConfig.SLOT_NAME.name());
        final ConfigValue pluginNameValue =
                configValues.get(OpengaussConnectorConfig.PLUGIN_NAME.name());
        ...
        try (OpengaussConnection connection =
                new OpengaussConnection(postgresConfig.getJdbcConfig())) {
            try {
