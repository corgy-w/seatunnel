...
/**
 * Abstraction of OpenGauss log sequence number, adapted from {@link
 * org.opengauss.replication.LogSequenceNumber}.
 *
...
public class Lsn implements Comparable<Lsn> {
    ...
    /**
     * @param value OpenGauss JDBC driver domain type representing position in the write-ahead log
     *     stream
     * @return not null LSN instance
     */
    ...
    /** @return OpenGauss JDBC driver representation of position in the write-ahead log stream */
