...
package org.apache.seatunnel.connectors.seatunnel.cdc.opengauss.source.enumerator;
...
import org.apache.seatunnel.connectors.seatunnel.cdc.opengauss.utils.OpenGaussTypeUtils;
...
@Slf4j
public class OpenGaussChunkSplitter extends AbstractJdbcSourceChunkSplitter {

    public OpenGaussChunkSplitter(JdbcSourceConfig sourceConfig, JdbcDataSourceDialect dialect) {
    ...
    public Object[] queryMinMax(JdbcConnection jdbc, TableId tableId, String columnName)
            throws SQLException {
        return OpenGaussUtils.queryMinMax(jdbc, tableId, columnName);
    }
    ...
    public Object queryMin(
            ...
            throws SQLException {
        return OpenGaussUtils.queryMin(jdbc, tableId, columnName, excludedLowerBound);
    }
    ...
    public Object[] sampleDataFromColumn(
            ...
            throws SQLException {
        return OpenGaussUtils.skipReadAndSortSampleData(
    ...
    public Object queryNextChunkMax(
            ...
            throws SQLException {
        return OpenGaussUtils.queryNextChunkMax(
    ...
    public Long queryApproximateRowCnt(JdbcConnection jdbc, TableId tableId) throws SQLException {
        return OpenGaussUtils.queryApproximateRowCnt(jdbc, tableId);
    }
    ...
    public SeaTunnelDataType<?> fromDbzColumn(Column splitColumn) {
        return OpenGaussTypeUtils.convertFromColumn(splitColumn);
    }
}
