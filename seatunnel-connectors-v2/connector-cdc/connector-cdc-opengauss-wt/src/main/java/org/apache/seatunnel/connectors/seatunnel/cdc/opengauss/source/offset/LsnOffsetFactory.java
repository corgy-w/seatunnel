...
package org.apache.seatunnel.connectors.seatunnel.cdc.opengauss.source.offset;
...
public class LsnOffsetFactory extends OffsetFactory {
    ...
    private final OpenGaussDialect dialect;

    public LsnOffsetFactory(OpenGaussSourceConfigFactory configFactory, OpenGaussDialect dialect) {
    ...
    public Offset latest() {
        try (JdbcConnection jdbcConnection = dialect.openJdbcConnection(sourceConfig)) {
            return OpenGaussUtils.currentLsn((OpengaussConnection) jdbcConnection);
        } catch (Exception e) {
