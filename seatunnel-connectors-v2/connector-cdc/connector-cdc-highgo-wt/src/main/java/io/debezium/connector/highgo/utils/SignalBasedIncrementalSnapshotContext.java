...
public class SignalBasedIncrementalSnapshotContext<T>
    ...
    public static <U> SignalBasedIncrementalSnapshotContext<U> load(
            Map<String, ?> offsets, boolean useCatalogBeforeSchema) {
        final SignalBasedIncrementalSnapshotContext<U> context =
                new SignalBasedIncrementalSnapshotContext<>(useCatalogBeforeSchema);
