 ...
 */
public class HighGoType {

    public static final HighGoType UNKNOWN =
            new HighGoType("unknown", -1, Integer.MIN_VALUE, null, null, null, null);

    private final String name;
    private final int oid;
    private final int jdbcId;
    private final HighGoType parentType;
    private final HighGoType elementType;
    ...
    /** @return HighGo OID of this type */
    public int getOid() {
        return oid;
    }
    ...
    public boolean equals(Object obj) {
        ...
        HighGoType other = (HighGoType) obj;
        if (oid != other.oid) {
            return false;
        }
        return true;
