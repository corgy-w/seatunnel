...
/**
 * Parser for records produced by HighGo connectors.
 *
 * @author Chris Cranford
 */
public class HighGoRecordParser extends RecordParser {
    ...
    public HighGoRecordParser(Schema schema, Struct record) {
    ...
    public Object getMetadata(String name) {
        ...
        throw new DataException(
                "No such field \""
                        + name
                        + "\" in the \"source\" field of events from HighGo connector");
    }
}
