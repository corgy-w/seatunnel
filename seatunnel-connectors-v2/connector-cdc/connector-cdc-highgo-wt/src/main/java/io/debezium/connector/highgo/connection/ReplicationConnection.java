...
public interface ReplicationConnection extends AutoCloseable {
     ...
     * connections.
     *
     * @param config a {@link HighGoConnectorConfig} instance; may not be null
     * @return a builder, never null
     */
    static Builder builder(HighGoConnectorConfig config) {
        return new HighGoReplicationConnection.ReplicationConnectionBuilder(config);
    }
    ...
    interface Builder {
        ...
        Builder withPublicationAutocreateMode(
                final HighGoConnectorConfig.AutoCreateMode publicationAutocreateMode);
         ...
         */
        Builder withPlugin(final HighGoConnectorConfig.LogicalDecoder plugin);
         ...
         * @return this instance
         */
        Builder withSchema(HighGoSchema schema);
