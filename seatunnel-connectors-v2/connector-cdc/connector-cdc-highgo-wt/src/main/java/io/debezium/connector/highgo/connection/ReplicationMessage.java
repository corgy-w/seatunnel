...
/**
 * An abstract representation of a replication message that is sent by a HighGo logical decoding
 * plugin and is processed by the Debezium HighGo connector.
 *
...
public interface ReplicationMessage {
    ...
    public interface Column {
        ...
        Object getValue(
                final HighGoStreamingChangeEventSource.PgConnectionSupplier connection,
    ...
    public interface ColumnValue<T> {
        ...
        boolean isArray(HighGoType type);
     ...
     * MessageDecoder}. Enables {@link HighGoStreamingChangeEventSource} to advance LSN forward even
     * in case of such messages.
     */
