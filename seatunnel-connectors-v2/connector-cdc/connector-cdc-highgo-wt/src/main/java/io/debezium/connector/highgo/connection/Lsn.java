...
/**
 * Abstraction of HighGo log sequence number, adapted from {@link
 * com.highgo.jdbc.replication.LogSequenceNumber}.
 *
...
public class Lsn implements Comparable<Lsn> {
    ...
    /**
     * @param value HighGo JDBC driver domain type representing position in the write-ahead log
     *     stream
     * @return not null LSN instance
     */
    ...
    /** @return HighGo JDBC driver representation of position in the write-ahead log stream */
