...
import io.debezium.connector.highgo.utils.DefaultValueConverter;
...
@ThreadSafe
public class HighGoDefaultValueConverter implements DefaultValueConverter {

    private static Logger LOGGER = LoggerFactory.getLogger(HighGoDefaultValueConverter.class);
    ...
    private final HighGoValueConverter valueConverters;
    private final Map<String, DefaultValueMapper> defaultValueMappers;

    public HighGoDefaultValueConverter(
            HighGoValueConverter valueConverters, TimestampUtils timestampUtils) {
