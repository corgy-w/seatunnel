...
import io.debezium.connector.highgo.utils.SignalBasedIncrementalSnapshotContext;
...
public class HighGoOffsetContext implements OffsetContext {
    ...
    public static class Loader implements OffsetContext.Loader<HighGoOffsetContext> {

        private final HighGoConnectorConfig connectorConfig;

        public Loader(HighGoConnectorConfig connectorConfig) {
        ...
        @Override
        public HighGoOffsetContext load(Map<String, ?> offset) {
            ...
            return new HighGoOffsetContext(
                    connectorConfig,
                    lsn,
    ...
    public String toString() {
        return "HighGoOffsetContext [sourceInfoSchema="
                + sourceInfoSchema
                + ", sourceInfo="
                + sourceInfo
                + ", lastSnapshotRecord="
    ...
    public static HighGoOffsetContext initialContext(
            HighGoConnectorConfig connectorConfig, HighGoConnection jdbcConnection, Clock clock) {
