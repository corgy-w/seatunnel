...
public abstract class RecordsProducer {
    ...
    protected final HighGoTaskContext taskContext;
    protected final SourceInfo sourceInfo;

    protected RecordsProducer(HighGoTaskContext taskContext, SourceInfo sourceInfo) {
    ...
    /**
     * Starts up this producer. This is normally done by a {@link HighGoConnectorTask} instance.
