...
package org.apache.seatunnel.connectors.seatunnel.cdc.highgo.source.offset;
...
import org.apache.seatunnel.connectors.seatunnel.cdc.highgo.source.HighGoDialect;
...
public class LsnOffsetFactory extends OffsetFactory {
    ...
    public LsnOffsetFactory(HighGoSourceConfigFactory configFactory, HighGoDialect dialect) {
    ...
    public Offset latest() {
        try (JdbcConnection jdbcConnection = dialect.openJdbcConnection(sourceConfig)) {
            return HighGoUtils.currentLsn((HighGoConnection) jdbcConnection);
        } catch (Exception e) {
