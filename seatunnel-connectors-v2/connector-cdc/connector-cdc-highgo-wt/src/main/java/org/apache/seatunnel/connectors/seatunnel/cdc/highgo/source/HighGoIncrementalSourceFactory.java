...
public class HighGoIncrementalSourceFactory implements TableSourceFactory {
    @Override
    public String factoryIdentifier() {
        return HighGoIncrementalSource.IDENTIFIER;
    }
    ...
    public OptionRule optionRule() {
        return JdbcSourceOptions.getBaseRule()
                ...
                .optional(
                        ...
                        HighGoOptions.DECODING_PLUGIN_NAME,
                        HighGoOptions.SLOT_NAME,
                ...
                .optional(HighGoSourceOptions.STARTUP_MODE, HighGoSourceOptions.STOP_MODE)
                .build();
    }

    @Override
    public Class<? extends SeaTunnelSource> getSourceClass() {
        return HighGoIncrementalSource.class;
    }
    ...
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
        ...
        return () -> {
            try {
                ...
                throw new RuntimeException("HighGo driver not found.", e);
            }
            ...
            return (SeaTunnelSource<T, SplitT, StateT>)
                    new HighGoIncrementalSource<>(context.getOptions(), dataType, catalogTables);
        };
    }
}
