...
package org.apache.seatunnel.connectors.seatunnel.cdc.highgo.source.reader.wal;
...
@Slf4j
public class HighGoWalFetchTask implements FetchTask<SourceSplitBase> {
    private final IncrementalSplit split;
    private volatile boolean taskRunning = false;
    private Long lastCommitLsn;
    private HighGoStreamingChangeEventSource streamingChangeEventSource;
    private HighGoOffsetContext offsetContext;

    public HighGoWalFetchTask(IncrementalSplit split) {
        this.split = split;
    }
    ...
    public void execute(Context context) throws Exception {
        ...
        streamingChangeEventSource =
                new HighGoStreamingChangeEventSource(
                        sourceFetchContext.getDbzConnectorConfig(),
                        sourceFetchContext.getSnapshotter(),
                        sourceFetchContext.getDataConnection(),
                        sourceFetchContext.getHighGoEventDispatcher(),
    ...
    public void commitCurrentOffset(LsnOffset offset) {
        if (streamingChangeEventSource != null && offset != null) {
            ...
            if (commitLsn != null
                ...
                offsets.put(HighGoOffsetContext.LAST_COMMIT_LSN_KEY, lastCommitLsn);
