...
package org.apache.seatunnel.connectors.seatunnel.cdc.highgo.source.reader.snapshot;
...
@Slf4j
public class HighGoSnapshotFetchTask implements FetchTask<SourceSplitBase> {

    private final SnapshotSplit split;

    private volatile boolean taskRunning = false;

    private HighGoSnapshotSplitReadTask snapshotSplitReadTask;

    public HighGoSnapshotFetchTask(SnapshotSplit split) {
        this.split = split;
    }
    ...
    public void execute(Context context) throws Exception {
        ...
        snapshotSplitReadTask =
                new HighGoSnapshotSplitReadTask(
