...
package org.apache.seatunnel.connectors.seatunnel.cdc.highgo.option;

import org.apache.seatunnel.api.configuration.Option;
import org.apache.seatunnel.api.configuration.Options;

public interface HighGoOptions {
    ...
    Option<String> SLOT_NAME =
            Options.key("slot.name")
                    ...
                    .withDescription(
                            "The name of the HighGo logical decoding slot that was created for streaming changes "
