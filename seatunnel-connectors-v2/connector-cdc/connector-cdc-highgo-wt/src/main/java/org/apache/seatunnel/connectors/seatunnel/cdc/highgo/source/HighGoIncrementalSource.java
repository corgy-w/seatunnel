...
public class HighGoIncrementalSource<T> extends IncrementalSource<T, JdbcSourceConfig>
    ...
    public HighGoIncrementalSource(ReadonlyConfig options, List<CatalogTable> catalogTables) {
    ...
    public Option<StartupMode> getStartupModeOption() {
        return HighGoSourceOptions.STARTUP_MODE;
    }

    @Override
    public Option<StopMode> getStopModeOption() {
        return HighGoSourceOptions.STOP_MODE;
    }

    @Override
    public SourceConfig.Factory<JdbcSourceConfig> createSourceConfigFactory(ReadonlyConfig config) {
        HighGoSourceConfigFactory configFactory = new HighGoSourceConfigFactory();
    ...
    public DataSourceDialect<JdbcSourceConfig> createDataSourceDialect(ReadonlyConfig config) {
        return new HighGoDialect((HighGoSourceConfigFactory) configFactory, catalogTables);
    }

    @Override
    public OffsetFactory createOffsetFactory(ReadonlyConfig config) {
        return new LsnOffsetFactory(
                (HighGoSourceConfigFactory) configFactory, (HighGoDialect) dataSourceDialect);
    }
    ...
    private Map<TableId, Struct> tableChanges() {
        ...
        HighGoDialect dialect =
                new HighGoDialect((HighGoSourceConfigFactory) configFactory, catalogTables);
