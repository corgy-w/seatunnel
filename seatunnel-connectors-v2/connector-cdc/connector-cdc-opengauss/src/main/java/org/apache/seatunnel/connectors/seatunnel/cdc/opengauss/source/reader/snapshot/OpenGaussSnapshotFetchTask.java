...
package org.apache.seatunnel.connectors.seatunnel.cdc.opengauss.source.reader.snapshot;
...
@Slf4j
public class OpenGaussSnapshotFetchTask implements FetchTask<SourceSplitBase> {

    private final SnapshotSplit split;

    private volatile boolean taskRunning = false;

    private OpenGaussSnapshotSplitReadTask snapshotSplitReadTask;

    public OpenGaussSnapshotFetchTask(SnapshotSplit split) {
        this.split = split;
    }
    ...
    public void execute(Context context) throws Exception {
        ...
        snapshotSplitReadTask =
                new OpenGaussSnapshotSplitReadTask(
