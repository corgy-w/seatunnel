 ...
 */
public class OpengaussStreamingChangeEventSource implements StreamingChangeEventSource<OpengaussOffsetContext> {
    ...
    private void processMessages(ChangeEventSourceContext context, OpengaussOffsetContext offsetContext, final ReplicationStream stream)
            ...
            boolean receivedMessage = stream.readPending(message -> {
                ...
                if (message.isTransactionalMessage()) {
                    ...
                    if (message.getOperation() == Operation.BEGIN) {
                        dispatcher.dispatchTransactionStartedEvent( toString(message.getTransactionId()), offsetContext);
                    }
    ...
    private void commitMessage( OpengaussOffsetContext offsetContext, final Lsn lsn) throws SQLException, InterruptedException {
        lastCompletelyProcessedLsn = lsn;
