...
public class LogicalDecodingMessageMonitor {
    ...
    public static final String ENVELOPE_OPERATION_MESSAGE_CODE = "m";
    ...
    public void logicalDecodingMessageEvent( OffsetContext offsetContext, Long timestamp,
        ...
        value.put(Envelope.FieldName.OPERATION, ENVELOPE_OPERATION_MESSAGE_CODE);
        ...
        sender.accept(new SourceRecord(new HashMap<>(), offsetContext.getOffset(), topicName,
