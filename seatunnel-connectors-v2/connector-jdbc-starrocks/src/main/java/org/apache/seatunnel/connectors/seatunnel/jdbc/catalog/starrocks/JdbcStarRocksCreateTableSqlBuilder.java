...
public class JdbcStarRocksCreateTableSqlBuilder {
    ...
    private final JdbcStarRocksTypeConverter typeConverter;
    private boolean createIndex;

    private JdbcStarRocksCreateTableSqlBuilder(
            String tableName, JdbcStarRocksTypeConverter typeConverter, boolean createIndex) {
    ...
    public static JdbcStarRocksCreateTableSqlBuilder builder(
            TablePath tablePath,
            CatalogTable catalogTable,
            JdbcStarRocksTypeConverter typeConverter,
            boolean createIndex) {
        ...
        return new JdbcStarRocksCreateTableSqlBuilder(
    ...
    public JdbcStarRocksCreateTableSqlBuilder addColumn(List<Column> columns) {
        checkArgument(CollectionUtils.isNotEmpty(columns), "columns must not be empty");
        this.columns = columns;
        return this;
    }

    public JdbcStarRocksCreateTableSqlBuilder primaryKey(PrimaryKey primaryKey) {
        this.primaryKey = primaryKey;
        return this;
    }

    public JdbcStarRocksCreateTableSqlBuilder fieldIde(String fieldIde) {
        this.fieldIde = fieldIde;
        return this;
    }

    public JdbcStarRocksCreateTableSqlBuilder constraintKeys(List<ConstraintKey> constraintKeys) {
        this.constraintKeys = constraintKeys;
        return this;
    }

    public JdbcStarRocksCreateTableSqlBuilder engine(String engine) {
        this.engine = engine;
        return this;
    }

    public JdbcStarRocksCreateTableSqlBuilder charset(String charset) {
        this.charset = charset;
        return this;
    }

    public JdbcStarRocksCreateTableSqlBuilder collate(String collate) {
        this.collate = collate;
        return this;
    }

    public JdbcStarRocksCreateTableSqlBuilder comment(String comment) {
