...
public class RedshiftTypeConverter implements TypeConverter<BasicTypeDefine> {
    ...
    public static final String REDSHIFT_DATE = "DATE";
    ...
    public Column convert(BasicTypeDefine typeDefine) {
        ...
        switch (dataType) {
            ...
            case REDSHIFT_BINARY_VARYING:
                ...
                break;
            case REDSHIFT_DATE:
                builder.sourceType(REDSHIFT_DATE);
    ...
    public BasicTypeDefine reconvert(Column column) {
        ...
        switch (column.getDataType().getSqlType()) {
            ...
            case BYTES:
                ...
                break;
            case DATE:
                builder.columnType(REDSHIFT_DATE);
                builder.dataType(REDSHIFT_DATE);
                break;
            case TIME:
