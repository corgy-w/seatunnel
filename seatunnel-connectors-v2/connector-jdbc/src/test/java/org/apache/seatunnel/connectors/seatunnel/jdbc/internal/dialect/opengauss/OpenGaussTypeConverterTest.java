...
import org.apache.seatunnel.connectors.seatunnel.jdbc.catalog.opengauss.OpenGaussTypeConverter;

import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;

public class OpenGaussTypeConverterTest {
    @Test
    public void testConvertUnsupported() {
        BasicTypeDefine<Object> typeDefine =
                BasicTypeDefine.builder().name("test").columnType("aaa").dataType("aaa").build();
        try {
            OpenGaussTypeConverter.INSTANCE.convert(typeDefine);
            Assertions.fail();
    ...
    public void testReconvertUnsupported() {
        Column column =
                PhysicalColumn.of(
                        ...
                        null);
        try {
            OpenGaussTypeConverter.INSTANCE.reconvert(column);
            Assertions.fail();
        } catch (SeaTunnelRuntimeException e) {
            // ignore
        } catch (Throwable e) {
    ...
    public void testReconvertBoolean() {
        ...
        BasicTypeDefine typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_BOOLEAN, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_BOOLEAN, typeDefine.getDataType());
    ...
    public void testReconvertByte() {
        ...
        BasicTypeDefine typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_SMALLINT, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_SMALLINT, typeDefine.getDataType());
    }
    ...
    public void testReconvertInt() {
        ...
        BasicTypeDefine typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_INTEGER, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_INTEGER, typeDefine.getDataType());
    }
    ...
    public void testReconvertLong() {
        ...
        BasicTypeDefine typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_BIGINT, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_BIGINT, typeDefine.getDataType());
    }
    ...
    public void testReconvertFloat() {
        ...
        BasicTypeDefine typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_REAL, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_REAL, typeDefine.getDataType());
    }
    ...
    public void testReconvertDouble() {
        ...
        Assertions.assertEquals(
                OpenGaussTypeConverter.PG_DOUBLE_PRECISION, typeDefine.getColumnType());
        Assertions.assertEquals(
                OpenGaussTypeConverter.PG_DOUBLE_PRECISION, typeDefine.getDataType());
    }
    ...
    public void testReconvertDecimal() {
        ...
        Assertions.assertEquals(
                String.format(
                        "%s(%s,%s)",
                        OpenGaussTypeConverter.PG_NUMERIC,
                        OpenGaussTypeConverter.DEFAULT_PRECISION,
                        OpenGaussTypeConverter.DEFAULT_SCALE),
                typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_NUMERIC, typeDefine.getDataType());

        column = PhysicalColumn.builder().name("test").dataType(new DecimalType(10, 2)).build();

        typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(
                String.format("%s(%s,%s)", OpenGaussTypeConverter.PG_NUMERIC, 10, 2),
                typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_NUMERIC, typeDefine.getDataType());
    }
    ...
    public void testReconvertBytes() {
        ...
        BasicTypeDefine typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_BYTEA, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_BYTEA, typeDefine.getDataType());
    }
    ...
    public void testReconvertString() {
        ...
        BasicTypeDefine typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_TEXT, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_TEXT, typeDefine.getDataType());
        ...
        Assertions.assertEquals(
                String.format(
                        "%s(%s)", OpenGaussTypeConverter.PG_VARCHAR, column.getColumnLength()),
                typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_VARCHAR, typeDefine.getDataType());
    ...
    public void testReconvertDate() {
        ...
        BasicTypeDefine typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_DATE, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_DATE, typeDefine.getDataType());
    }
    ...
    public void testReconvertTime() {
        ...
        BasicTypeDefine typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_TIME, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_TIME, typeDefine.getDataType());
        ...
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(
                String.format("%s(%s)", OpenGaussTypeConverter.PG_TIME, column.getScale()),
                typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_TIME, typeDefine.getDataType());
    ...
    public void testReconvertDatetime() {
        ...
        BasicTypeDefine typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_TIMESTAMP, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_TIMESTAMP, typeDefine.getDataType());
        ...
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(
                String.format("%s(%s)", OpenGaussTypeConverter.PG_TIMESTAMP, column.getScale()),
                typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_TIMESTAMP, typeDefine.getDataType());
        Assertions.assertEquals(column.getScale(), typeDefine.getScale());
        ...
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(
                String.format("%s(%s)", OpenGaussTypeConverter.PG_TIMESTAMP, 6),
                typeDefine.getColumnType());
    }
    ...
    public void testReconvertArray() {
        ...
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(
                OpenGaussTypeConverter.PG_BOOLEAN_ARRAY, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_BOOLEAN_ARRAY, typeDefine.getDataType());

        column = PhysicalColumn.builder().name("test").dataType(ArrayType.BYTE_ARRAY_TYPE).build();
        typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(
                OpenGaussTypeConverter.PG_SMALLINT_ARRAY, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_SMALLINT_ARRAY, typeDefine.getDataType());
        ...
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(
                OpenGaussTypeConverter.PG_INTEGER_ARRAY, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_INTEGER_ARRAY, typeDefine.getDataType());

        column = PhysicalColumn.builder().name("test").dataType(ArrayType.LONG_ARRAY_TYPE).build();
        typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_BIGINT_ARRAY, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_BIGINT_ARRAY, typeDefine.getDataType());

        column = PhysicalColumn.builder().name("test").dataType(ArrayType.FLOAT_ARRAY_TYPE).build();
        typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_REAL_ARRAY, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_REAL_ARRAY, typeDefine.getDataType());
        ...
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(
                OpenGaussTypeConverter.PG_DOUBLE_PRECISION_ARRAY, typeDefine.getColumnType());
        Assertions.assertEquals(
                OpenGaussTypeConverter.PG_DOUBLE_PRECISION_ARRAY, typeDefine.getDataType());

        column =
                PhysicalColumn.builder().name("test").dataType(ArrayType.STRING_ARRAY_TYPE).build();
        typeDefine = OpenGaussTypeConverter.INSTANCE.reconvert(column);
        Assertions.assertEquals(column.getName(), typeDefine.getName());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_TEXT_ARRAY, typeDefine.getColumnType());
        Assertions.assertEquals(OpenGaussTypeConverter.PG_TEXT_ARRAY, typeDefine.getDataType());
