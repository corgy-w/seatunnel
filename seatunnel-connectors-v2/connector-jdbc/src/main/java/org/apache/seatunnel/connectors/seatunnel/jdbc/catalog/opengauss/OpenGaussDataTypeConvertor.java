...
/** @deprecated instead by {@link OpenGaussTypeConverter} */
@Deprecated
...
public class OpenGaussDataTypeConvertor implements DataTypeConvertor<String> {
    ...
    public SeaTunnelDataType<?> toSeaTunnelType(
        ...
        switch (connectorDataType) {
            case OpenGaussTypeConverter.PG_NUMERIC:
        ...
        BasicTypeDefine typeDefine =
                BasicTypeDefine.builder()
                        ...
                        .scale(scale)
                        .build();
        return OpenGaussTypeConverter.INSTANCE.convert(typeDefine).getDataType();
    }
