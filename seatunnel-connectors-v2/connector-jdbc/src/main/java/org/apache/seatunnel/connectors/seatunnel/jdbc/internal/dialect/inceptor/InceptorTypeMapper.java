...
public class InceptorTypeMapper implements JdbcDialectTypeMapper {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(InceptorTypeMapper.class);
        ...
        switch (columnType) {
            ...
            default:
                ...
                throw CommonError.convertToSeaTunnelTypeError(
                        DatabaseIdentifier.INCEPTOR, PluginType.SOURCE, columnType, jdbcColumnName);
        }
    }
}
