...
/** @deprecated instead by {@link KingbaseTypeConverter} */
@Deprecated
...
public class KingBaseDataTypeConvertor implements DataTypeConvertor<String> {
    ...
    public SeaTunnelDataType<?> toSeaTunnelType(
        ...
        switch (connectorDataType) {
            case KingbaseTypeConverter.PG_NUMERIC:
        ...
        BasicTypeDefine typeDefine =
                BasicTypeDefine.builder()
                        ...
                        .scale(scale)
                        .build();
        return KingbaseTypeConverter.INSTANCE.convert(typeDefine).getDataType();
    }
