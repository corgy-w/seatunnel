        ...
        switch (dataType) {
            ...
            default:
                throw CommonError.convertToSeaTunnelTypeError(
                        "SnowflakeFile", dataType, typeDefine.getName());
        }
        ...
        switch (column.getDataType().getSqlType()) {
            ...
            case DECIMAL:
                ...
                if (precision <= 0) {
                    ...
                    scale = DEFAULT_SCALE;
                    log.warn(
                            "The decimal column {} has invalid precision {}, "
                                    + "using default precision {} and scale {}",
                            column.getName(),
                            precision,
                            DEFAULT_PRECISION,
                            DEFAULT_SCALE);
                    ...
                    log.warn(
                            "The decimal column {} precision {} exceeds maximum {}, "
                                    + "using maximum precision {} and adjusted scale {}",
                            column.getName(),
                ...
                if (scale < 0) {
                    scale = 0;
                    log.warn(
                            "The decimal column {} has negative scale {}, " + "using scale 0",
                            column.getName(),
                            scale);
                } else if (scale > MAX_SCALE) {
                    scale = MAX_SCALE;
                    log.warn(
                            "The decimal column {} scale {} exceeds maximum {}, "
                                    + "using maximum scale {}",
                            column.getName(),
