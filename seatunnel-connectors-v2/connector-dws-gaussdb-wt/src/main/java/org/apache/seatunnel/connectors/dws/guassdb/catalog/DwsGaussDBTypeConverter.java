...
public class DwsGaussDBTypeConverter implements TypeConverter<BasicTypeDefine> {
    ...
    public static final DwsGaussDBTypeConverter INSTANCE = new DwsGaussDBTypeConverter();
        ...
        switch (pgDataType) {
            ...
            default:
                throw CommonError.convertToSeaTunnelTypeError(
                        DwsGaussDBConfig.CONNECTOR_NAME,
